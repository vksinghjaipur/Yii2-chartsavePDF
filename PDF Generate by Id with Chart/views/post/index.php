...
<div class="container mt-3">
  ...
  <span><?= Html::a('Generate PDF', ['post/gen-mypdf'], ['class' => 'btn btn-success', 'target' => '_blank']) ?></span>
  <span><?= Html::a('PDF with Contents', ['post/gen-pdfcontent'], ['class' => 'btn btn-warning', 'target' => '_blank']) ?></span>
  ...
  <table class="table">
    ...
    <?php if(count($posts)>0):?>	
        ...
        <td><?php echo $index + 1; ?></td>
            ...
            <span><?= Html::a('PDF', ['gen-pdf', 'id' => $post->id], ['class' => 'btn btn-warning btn-sm', 'target'=> '_blank']) ?></span>
        	</td>
      	</tr>
      	<?php endforeach; ?>
